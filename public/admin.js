...
function handleError(context, error, email) {
    ...
    sendErrorLog(email, `${context}: ${error.message}`);
}
      ...
      `;
        ...
        editButton.addEventListener('click', () => {
            ...
            if (editText !== null && editPrice !== null && editQuantity !== null) {
                fetch(`/posts/${postId}`, {
                    ...
                    .then((data) => {
                        if (data.error) {
                            handleError('Error editing post', new Error(data.error), currentUserEmail);
                        } else {
                    ...
                    .catch((error) => {
                        handleError('Error editing post', error, currentUserEmail);
                    });
            }
        });
        ...
        deleteButton.addEventListener('click', () => {
            fetch(`/posts/${postId}`, {
                ...
                .then((data) => {
                    if (data.error) {
                        handleError('Error deleting post', new Error(data.error), currentUserEmail);
                    } else {
                        newPost.remove();
                ...
                .catch((error) => {
                    handleError('Error deleting post', error, currentUserEmail);
                });
        });
